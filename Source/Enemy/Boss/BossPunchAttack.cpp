...
{
	rightHandImg = LoadGraph("Resources/Enemy/rightHand.png");
...
{
	DrawRotaGraph(shape_->GetCenter().x,shape_->GetCenter().y,1.0,-3.14/4,rightHandImg,true,dir_ == 1);
}
...
{
	return isAttack_ || isPreparation;
}
